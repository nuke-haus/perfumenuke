                    ...
                    <td>
                        ...
                        <div>
                            <input type="number" 
                                   ...
                                   min="0"
                                   max="100"
                                   defaultValue={(parseFloat(matData.percent || "0") * 100.0)}
                                   onChange={(event) =>  this._changeMixtureMaterial(index, "percent", PN.sanitizeFloat(0.01 * parseFloat(event.target.value || "0"), 8))}/>
                        </div>
                    </td>  
                    <td>
                        <button type="button" 
                            ...
                            <td>
                                ...
                                <div>
                                    <input type="number" 
                                           ...
                                           min="0"
                                           max="100"
                                           defaultValue={parseFloat(PN.database.currentMaterial.avg_in_concentrate || "0") * 100.0}
                                           onChange={(event) => this._onChangeMaterial("avg_in_concentrate", PN.sanitizeFloat(0.01 * parseFloat(event.target.value || "0"), 8))}/>
                                </div>
                            </td>
                            <td>
                                <div>
                                ...
                                <div>
                                    <input type="number" 
                                           ...
                                           min="0"
                                           max="100"
                                           defaultValue={parseFloat(PN.database.currentMaterial.max_in_concentrate || "0") * 100.0}
                                           onChange={(event) => this._onChangeMaterial("max_in_concentrate", PN.sanitizeFloat(0.01 * parseFloat(event.target.value || "0"), 8))}/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <div>
                                    <input type="number" 
                                           ...
                                           defaultValue={parseFloat(PN.database.currentMaterial.max_in_finished_product || "0") * 100.0}
                                           onChange={(event) => this._onChangeMaterial("max_in_finished_product", PN.sanitizeFloat(0.01 * parseFloat(event.target.value || "0"), 8))}/>
                                </div>
                            </td>
                        </tr>
